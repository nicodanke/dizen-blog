...
export const GlobalStyle = createGlobalStyle`
    ...
    ::-moz-selection {
        background-color: ${props => props.theme.mode === 'light' ? 'rgba(58, 189, 167, 0.3)' : 'rgba(255, 255, 255, 0.25)'};
    }
    ...
    code {
        background: ${props => props.theme.mode === 'light' ? 'rgba(0, 0, 0, 0.1)' : 'rgba(0, 0, 0, 0.25)'};
        padding: 0.25rem;
        border-radius: 4px;
        color: ${props => props.theme.body.text};
    }
...
export const Input = styled.input`
    ...
    font-size: ${props => props.theme.typography.fontSize};
    box-sizing: border-box;
    border: 2px solid ${props => props.theme.mode === 'light' ? 'rgba(0, 0, 0, 0.2)' : 'rgba(255, 255, 255, 0.2)'};
